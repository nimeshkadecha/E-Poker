...
public class roomCaseAdapter extends RecyclerView.Adapter<roomCaseAdapter.viewHolder> {
    private Context context;
    private ArrayList acnr, aroom, adate, alic, amobile, astatus;

    public roomCaseAdapter(Context context, ArrayList acnr, ArrayList aroom, ArrayList adate, ArrayList alic, ArrayList amobile, ArrayList astatus) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new roomCaseAdapter.viewHolder(view);
    }

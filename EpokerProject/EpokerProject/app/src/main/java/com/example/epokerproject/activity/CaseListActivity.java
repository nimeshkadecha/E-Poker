...
import com.example.epokerproject.databinding.ActivityCaseListBinding;
import com.example.epokerproject.interfaces.ItemClickListener;

public class CaseListActivity extends AppCompatActivity implements ItemClickListener {

    private static final String CHANNEL_ID = "com.example.epokerproject.activity.chanel01";
    CaseAdapter caseAdapter;
    private ActivityCaseListBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityCaseListBinding.inflate(getLayoutInflater());
    ...
    private void initView(){
        ...
        binding.rvCaseList.setAdapter(caseAdapter);
